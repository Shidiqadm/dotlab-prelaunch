...
!(function () {
  ...
  window.tram = (function (t) {
    ...
    var f = (function (t, e, n) {
      ...
      M = function (t) {
        ...
        for (e = 0; e < A.length; e++)
          if ((n = A[e] + i) in O.style) return { dom: n, css: q[e] + t };
      },
      $ = (e.support = {
    ...
    if ($.transition) {
      var L = $.timing.dom;
      if (((O.style[L] = h["ease-in-back"][0]), !O.style[L]))
    ...
    var D = (e.frame = (function () {
      ...
      B = f(function (e) {
        ...
        (e.init = function (e) {
          ...
          $.backface && W.hideBackface && Y(this.el, $.backface.css, "hidden");
        }),
          b("add", i),
          b("start", r),
          b("wait", function (t) {
            ...
            W.fallback || r.fallback
              ...
              : ((this.animate = this.transition),
                (this.string =
                  ...
                  this.duration +
                  "ms" +
                  ("ease" != this.ease ? z + h[this.ease][0] : "") +
      ...
      X = f(function (e) {
        ...
        function a() {
          var t,
            ...
            n,
            i = d.length;
          if (i) for (D(a), e = R(), t = i; t--; ) (n = d[t]) && n.render(e);
        }
        function u(e) {
          var n,
            i = t.inArray(e, d);
        ...
        (e.init = function (t) {
          ...
          (e.play = function () {
            this.active ||
              (this.start || (this.start = R()), (this.active = !0), n(this));
          }),
          (e.stop = function () {
  ...
  var e = {},
    ...
    r = t(function (t) {
      ...
      function l() {
        q && (q.reject(), m.off("load", q.resolve)),
          (q = new v.Deferred()),
          m.on("load", q.resolve);
      }
      var f = {},
        ...
        e.define(
          ...
          (t.exports = function (t, n, i) {
            ...
            function u(t) {
              return t.indexOf("//") >= 0
                ? t
                : c("https://editor-api.webflow.com" + t);
            }
            function c(t) {
              return t.replace(/([^:])\/\//g, "$1/");
            }
            if (
              ((i = i || {}), (e.env("test") || e.env("frame")) && !i.fixture)
            )
              return { exit: 1 };
            var l,
              f = {},
          ...
          (t.exports = function (t, n) {
            ...
            function r(e, n) {
              ...
              (r.handler = null),
                ...
                j.test(s) ? (r.handler = f) : s || (v ? (r.handler = l) : z());
            }
            function o() {
              (m = !0),
  ...
  t(function (t) {
    ...
    e.define(
      ...
      (t.exports = function (t, i) {
          ...
          if (c) {
            ...
            l &&
              ...
              i.each(l, function (t) {
                ...
                } else t.preload && !k ? A.push(i) : q.push(i);
              }));
          }
        }
        function u(t) {
        ...
        function l() {
          for (
            var t = b.scrollTop(), e = b.height(), n = O.length, i = 0;
            i < n;
            i++
          ) {
            var r = O[i],
          ...
          function i(e) {
            ...
            if (((d.href = n), !(n.indexOf(":") >= 0))) {
              ...
              if (0 === n.indexOf("#") && v.test(n)) {
                ...
                var c =
                  d.href === h.href || n === u || (m.test(n) && w.test(u));
                o(i, p, c);
              }
            }
          }
...
Webflow.require("ix").init([
  {
    slug: "show-intro-on-load",
    name: "show intro on load",
    value: {
      ...
      triggers: [
        {
          type: "load",
          stepsA: [
            { display: "block", opacity: 1, transition: "opacity 200 ease 0" },
          ],
          stepsB: [],
        },
      ],
  ...
  {
    slug: "coming-appear-on-load",
    name: "COMING appear on load ",
    value: {
  ...
  {
    slug: "soon-appear-on-load",
    name: "SOON appear on load",
    value: {
      style: { opacity: 0, x: "0px", y: "50px", z: "0px" },
      triggers: [
        {
  ...
  {
    slug: "text-appear-on-load",
    name: "text appear on load",
    value: {
      style: { opacity: 0, x: "0px", y: "50px", z: "0px" },
      triggers: [
        {
  ...
  {
    slug: "form-elements-start",
    name: "Form elements start",
    value: {
      style: { opacity: 0, x: "0px", y: "50px", z: "0px" },
      triggers: [],
    },
  ...
  {
    slug: "hide-wrapper-black",
    name: "Hide Wrapper Black",
    value: { style: { display: "none", opacity: 0 }, triggers: [] },
  },
  {
    slug: "show-wrapper-black-click",
    name: "Show Wrapper Black Click",
    value: {
      style: {},
      triggers: [
        {
          type: "click",
          selector: ".flexwrapper-white",
          stepsA: [
            { wait: "1000ms" },
            { display: "none", opacity: 0, transition: "opacity 200 ease 0" },
          ],
          stepsB: [],
        },
        {
          type: "click",
          selector: ".flexwrapper-black",
          stepsA: [
            { wait: "1000ms", display: "block" },
            {
              display: "block",
              opacity: 1,
        ...
        {
          type: "click",
          selector: ".input-field-copy",
          preserve3d: true,
          stepsA: [
            { wait: "2000ms", display: "block" },
            {
              opacity: 1,
              transition: "transform 500ms ease 0, opacity 500ms ease 0",
              x: "0px",
        ...
        {
          type: "click",
          selector: ".input-field-copy-2",
          preserve3d: true,
          stepsA: [
            { wait: "2250ms", display: "block" },
            {
              opacity: 1,
              transition: "transform 500ms ease 0, opacity 500ms ease 0",
              x: "0px",
  ...
  {
    slug: "show-wrapper-white-click",
    name: "Show wrapper White click",
    value: {
      style: { opacity: 0, x: "0px", y: "50px", z: "0px" },
      triggers: [
        {
        ...
        },
        {
          ...
          stepsA: [
            { wait: "1250ms" },
            { opacity: 0, transition: "opacity 500ms ease 0" },
            { display: "none" },
          ],
          stepsB: [],
        },
